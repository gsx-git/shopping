    ...
    <el-main class="product-detail-main">
        ...
        <el-card class="product-card">
            <template #header>
                <div class="product-header">
                    <!-- 店铺信息 -->
                    <div class="shop-bar" @click="router.push(`/shop/detail/${product.shopId}`)">
                ...
                <el-col :span="12" class="info-col">
                    <div class="product-info">
                        ...
                        <div class="product-actions">
                            ...
                            <el-button type="success" size="large" @click="toggleFavorite">
                                {{ isFavorited ? '已收藏' : '收藏' }}
                            </el-button>
                            <el-button type="warning" size="large" @click="openBuy"
        ...
        <el-card class="review-card">
            ...
            <div v-else class="review-list">
                <div v-for="review in (reviews.length > 3 ? reviews.slice(0, 3) : reviews)" :key="review.id"
                    class="review-box">
                ...
                <div v-for="r in reviews" :key="r.id" class="review-box">
                    ...
                    <div class="review-main">
                        <div class="review-line">
                            ...
                            <el-rate v-model="r.score" disabled show-score text-color="#ff9900"
...
const productScore = computed(() =>
    Number((product.value.score || 0).toFixed(1))
)
